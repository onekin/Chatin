...
const PromptStyles = {
  ...
  AnswerItem: {'backgroundColor': 'rgb(150, 219, 11)', 'font_color': '#FFFFFF', 'bold': true, line_position: null},
  AnswerItemPDFBased: {'backgroundColor': 'rgb(43, 217, 217)', 'font_color': '#FFFFFF', 'bold': true, line_position: null},
  AnswerItemAggregation: {'backgroundColor': 'rgb(0, 100, 0)', 'font_color': '#FFFFFF', 'bold': true, line_position: null},
